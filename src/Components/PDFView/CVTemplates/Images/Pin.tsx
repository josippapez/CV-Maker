...
const Pin = (props: { width?: number; height?: number }) => {
  ...
  return (
    <Svg width={width} height={height} viewBox='0 0 68.634 68.634'>
      <G>
        <Path
          fill='white'
          d='M34.823,0.016C34.722,0.006,34.62,0,34.516,0l-0.209,0.003L34.118,0
     ...
     c0.047,0.003,0.094,0.005,0.142,0.005c11.771,0.187,21.349,9.917,21.349,21.69C55.817,42.238,40.07,56.891,34.317,61.758z'
        ...
        <Path
          fill='white'
          d='M34.517,13.895c-7.004,0-12.682,5.678-12.682,12.683c0,7.003,5.678,12.681,12.682,12.681
