...
export const Template3: FC<Props> = ({
  ...
  return (
    <Page size='A4' style={[styles.page]}>
      <View
        style={[styles.personalInfo, styles.paddingX40, styles.marginBottom20]}
      >
        <Svg
          viewBox='0 0 595 200'
          width={595}
        ...
        >
          <Defs>
            <LinearGradient id='myLinearGradient' x1={0} x2={0} y1={0} y2={1}>
        ...
        <View
          style={[
            styles.topBar,
            { paddingTop: 40, paddingBottom: 10, zIndex: 1 },
          ]}
        >
